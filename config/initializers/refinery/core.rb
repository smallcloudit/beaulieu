...
Refinery::Core.configure do |config|
  ...
  # If you have to.
  config.s3_bucket_name = ENV['beaulieu-prod']
  # config.s3_region = ENV['S3_REGION']
  config.s3_access_key_id = ENV['AKIAIZ4GTXMGXDJIZTSQ']
  config.s3_secret_access_key = ENV['1nHhPckQTlSfhT/EgRK/F4uKCiVUYlSG+hcUWLdU']
  ...
  # Site name
  config.site_name = "Beaulieu Farm"

  # This activates Google Analytics tracking within your website. If this
  # config is left blank or set to UA-xxxxxx-x then no remote calls to
  # Google Analytics are made.
  config.google_analytics_page_code = "UA--77277454-1"
  ...
  # config.dragonfly_secret = "6e15a9f9e78393f82730b3499fb2f4eeb96949f29c9d7252"
